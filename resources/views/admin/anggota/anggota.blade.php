...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      <!-- Left navbar links -->
      <!-- SEARCH FORM -->
      <form class="form-inline ml-3" method="get" action="/anggota/cari" enctype="multipart/form-data">
            ...
            <table class="table table-bordered table-hover table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img src="{{asset('/data_file/'.$ang->foto) }}" style='width:80px; height:120px;'></td>
                  <td>
